import Highcharts, {Chart, Options, SeriesOptionsType, SeriesSplineOptions, XAxisOptions} from 'highcharts';
...
export default class SplineController {
    private _m_containerId: string;
    private _m_chart: Chart | null = null;
    private _m_series: Array<SeriesSplineOptions> = [{type: 'spline', name: '', data: []}];
